...
ALTER TABLE agendamentos ADD COLUMN IF NOT EXISTS payment_received BOOLEAN DEFAULT FALSE;
ALTER TABLE custos ADD COLUMN IF NOT EXISTS type VARCHAR(50) DEFAULT 'despesa';
